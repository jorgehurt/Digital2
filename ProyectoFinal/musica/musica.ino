...
//Cableadoooo
//Pata positica del buzzer a 3.3v de la tiva c.
//Pata negativa del buzzer a colector del buzzer
//Entre las patas postiva y negativa del buzzer colocar una resistencia de 470 ohms
//De la pata base del transistor a una resistencia de 470 ohm y de la resistencia al pin PF_2 de la tiva c
//De la pata emisor del transistor a tierra de la tiva c
